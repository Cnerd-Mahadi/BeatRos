...
export default function SignUp({ sessionId }: SignUpProps) {
					...
					<div className="space-y-8">
						...
						<div className="space-y-3 text-center">
							...
							<p className="mx-auto max-w-sm text-muted-foreground text-sm leading-relaxed">
								Create an account to unlock exclusive deals, personalized
								recommendations, and seamless order tracking
							</p>
						</div>
